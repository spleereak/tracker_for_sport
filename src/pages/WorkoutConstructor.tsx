    ...
    <div className="max-w-4xl mx-auto p-6">
      <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
        <div className="bg-gradient-to-r from-blue-500 to-purple-600 px-6 py-4">
          <h1 className="text-2xl font-bold text-white">Создание тренировки</h1>
        </div>
        ...
        <div className="p-6 space-y-6">
          ...
          <div className="space-y-2">
            <textarea
              ...
              className="w-full px-4 py-3 rounded-xl bg-gray-50 border border-gray-200 focus:border-blue-500 focus:ring-2 focus:ring-blue-200 outline-none transition-all min-h-[120px]"
          ...
          <div className="space-y-3">
            <h3 className="text-lg font-semibold text-gray-800">Сложность</h3>
          ...
          {selectionMode === 'auto' && (
            <div className="space-y-3">
              <h3 className="text-lg font-semibold text-gray-800">Выберите цели тренировки</h3>
          ...
          <div className="space-y-3">
            ...
            <div className="max-h-[400px] overflow-y-auto space-y-2 rounded-xl border border-gray-200 p-4 bg-gray-50">
              {(selectionMode === 'manual' ? exercisesList : newWorkout.exercises).map((exercise, i) => (
                <div key={i} className="w-full flex items-center gap-4 flex-wrap p-3 bg-white rounded-xl border border-gray-100 hover:border-blue-300 hover:shadow-sm transition-all">
                    ...
                    {exercise.countType === 'Время' && (
                      <div className="flex items-center gap-2">
                        ...
                        <input
                          ...
                          className="w-20 px-3 py-2 rounded-xl bg-gray-50 border border-gray-200 focus:border-blue-500 focus:ring-2 focus:ring-blue-200"
                        />
                    ...
                    {exercise.countType === 'Повторения' && (
                      <div className="flex items-center gap-2">
                        ...
                        <input
                          ...
                          className="w-20 px-3 py-2 rounded-xl bg-gray-50 border border-gray-200 focus:border-blue-500 focus:ring-2 focus:ring-blue-200"
                        />
                        <span className="text-sm text-gray-500">повт</span>
                      </div>
                    )}
                  ...
                  {exerciseSettings[exercise.id]?.warning && (
                    <div className="w-full mt-2 flex items-center gap-2 text-amber-600 bg-amber-50 px-3 py-2 rounded-lg">
                      <AlertTriangle className="w-4 h-4" />
                      <span className="text-sm">{exerciseSettings[exercise.id].warning}</span>
                    </div>
                  )}
                </div>
              ))}
          ...
          <div className="block w-full">
            <button
              className="w-full px-6 py-4 bg-gradient-to-r from-blue-500 to-blue-600 text-white rounded-xl font-semibold 
              hover:from-blue-600 hover:to-blue-700 transition-colors duration-400 flex items-center justify-center gap-2 shadow-lg shadow-blue-200"
