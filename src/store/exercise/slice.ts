...
const initialExercises: Exercise[] = [
  {
    ...
    image: ".src/public/assets/images/bench-press.jpg",
    difficulty: "Сложный",
  ...
  },
  {
    ...
    image: ".src/public/assets/images/bicep-curl.jpg",
    difficulty: "Средний",
    equipment: ["Гантели"],
    tags: ["Руки"],
    countType: "Повторения",
  ...
  },
  {
    ...
    image: ".src/public/assets/images/burpees.jpg",
    difficulty: "Сложный",
    equipment: ["Ничего"],
    tags: ["Кардио", "Корпус"],
    countType: "Повторения",
  ...
  },
  {
    ...
    image: ".src/public/assets/images/crunches.jpg",
  ...
  },
  {
    ...
    image: ".src/public/assets/images/deadlift.jpg",
    difficulty: "Сложный",
    equipment: ["Штанга"],
    tags: ["Спина", "Ноги"],
    countType: "Повторения",
  ...
  },
  {
    ...
    image: ".src/public/assets/images/dumbbell-squat.jpg",
    difficulty: "Средний",
    equipment: ["Гантели"],
    tags: ["Ноги"],
    countType: "Повторения",
  ...
  },
  {
    ...
    instruction: "1. Лягте на коврик\n2. Поднимите корпус\n3. Опустите корпус",
    image: ".src/public/assets/images/hyperextension.jpg",
    difficulty: "Средний",
    equipment: ["Коврик"],
    tags: ["Спина"],
    countType: "Повторения",
  ...
  },
  {
    ...
    image: ".src/public/assets/images/jump-rope.jpg",
    difficulty: "Средний",
    equipment: ["Скакалка"],
    tags: ["Кардио"],
    countType: "Время",
  ...
  },
  {
    ...
    image: ".src/public/assets/images/lateral-raises.png",
    difficulty: "Средний",
    equipment: ["Гантели"],
    tags: ["Руки"],
    countType: "Повторения",
  ...
  },
  {
    ...
    image: ".src/public/assets/images/lunges.jpg",
    difficulty: "Средний",
    equipment: ["Гантели"],
    tags: ["Ноги"],
    countType: "Повторения",
  ...
  },
  {
    ...
    image: ".src/public/assets/images/plank.jpeg",
    difficulty: "Средний",
    equipment: ["Коврик"],
    tags: ["Корпус"],
    countType: "Время",
  ...
  },
  {
    ...
    image: ".src/public/assets/images/pull-up.jpg",
    difficulty: "Сложный",
    equipment: ["Турник"],
    tags: ["Спина", "Руки"],
    countType: "Повторения",
  ...
  },
  {
    ...
    image: ".src/public/assets/images/push-up.jpg",
    difficulty: "Средний",
    equipment: ["Ничего"],
    tags: ["Грудь", "Руки"],
    countType: "Повторения",
  ...
  },
  {
    ...
    image: ".src/public/assets/images/running.jpg",
    difficulty: "Начинающий",
    equipment: ["Ничего"],
    tags: ["Кардио"],
    countType: "Время",
  ...
  },
  {
    ...
    image: ".src/public/assets/images/tricep-extension.jpg",
    difficulty: "Средний",
    equipment: ["Гантели"],
    tags: ["Руки"],
    countType: "Повторения",
