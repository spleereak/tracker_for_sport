...
const initialExercises: Exercise[] = [
  ...
  },
  {
    ...
    image: "./assets/images/dumbbell-squat.jpg",
    difficulty: "Средний",
    equipment: ["Гантели"],
    tags: ["Ноги"],
    countType: "Повторения",
  ...
  },
  {
    ...
    instruction: "1. Лягте на коврик\n2. Поднимите корпус\n3. Опустите корпус",
    image: "./assets/images/hyperextension.jpg",
    difficulty: "Средний",
    equipment: ["Коврик"],
    tags: ["Спина"],
    countType: "Повторения",
  ...
  },
  {
    ...
    image: "./assets/images/lateral-raises.png",
    difficulty: "Средний",
    equipment: ["Гантели"],
    tags: ["Руки"],
    countType: "Повторения",
  ...
  },
  {
    ...
    image: "./assets/images/tricep-extension.jpg",
    difficulty: "Средний",
    equipment: ["Гантели"],
    tags: ["Руки"],
    countType: "Повторения",
